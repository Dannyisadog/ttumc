...
var $updateUserPermissionInput = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.update-user-permission-input');
...
function updateUserPermission(isAdmin, user_id) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
    ...
    success: function success(resp) {
      if (resp.success) {
        toastr__WEBPACK_IMPORTED_MODULE_1___default.a.success('更新成功');
      } else {
        toastr__WEBPACK_IMPORTED_MODULE_1___default.a.error('系統發生錯誤');
      }
    },
...
function bindEvents() {
  $updateUserPermissionInput.on('click', function () {
    ...
    updateUserPermission(isAdmin, jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('user-id'));
  });
}
...
/***/ 2:
/*!****************************************!*\
  !*** multi ./resources/js/user_mgm.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/danny/Documents/common/coding/php/ttumc/resources/js/user_mgm.js */"./resources/js/user_mgm.js");
